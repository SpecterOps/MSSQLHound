...
var takeOwnershipTestCases = []edgeTestCase{
	...
	{EdgeType: "MSSQL_TakeOwnership", Description: "Login can take ownership of server role", SourcePattern: "TakeOwnershipTest_Login_CanTakeServerRole@*", TargetPattern: "TakeOwnershipTest_ServerRole_Target@*", EdgeProperties: map[string]interface{}{"traversable": false}},
	{EdgeType: "MSSQL_TakeOwnership", Description: "Server role can take ownership of another server role", SourcePattern: "TakeOwnershipTest_ServerRole_Source@*", TargetPattern: "TakeOwnershipTest_ServerRole_Target@*", EdgeProperties: map[string]interface{}{"traversable": false}},
	{EdgeType: "MSSQL_TakeOwnership", Description: "Database user can take ownership of database", SourcePattern: "TakeOwnershipTest_User_CanTakeDb@*\\EdgeTest_TakeOwnership", TargetPattern: "*\\EdgeTest_TakeOwnership", EdgeProperties: map[string]interface{}{"traversable": false}},
	{EdgeType: "MSSQL_TakeOwnership", Description: "Database role can take ownership of database", SourcePattern: "TakeOwnershipTest_DbRole_CanTakeDb@*\\EdgeTest_TakeOwnership", TargetPattern: "*\\EdgeTest_TakeOwnership", EdgeProperties: map[string]interface{}{"traversable": false}},
	{EdgeType: "MSSQL_TakeOwnership", Description: "Application role can take ownership of database", SourcePattern: "TakeOwnershipTest_AppRole_CanTakeDb@*\\EdgeTest_TakeOwnership", TargetPattern: "*\\EdgeTest_TakeOwnership", EdgeProperties: map[string]interface{}{"traversable": false}},
	{EdgeType: "MSSQL_TakeOwnership", Description: "Database user can take ownership of database role", SourcePattern: "TakeOwnershipTest_User_CanTakeRole@*\\EdgeTest_TakeOwnership", TargetPattern: "TakeOwnershipTest_DbRole_Target@*\\EdgeTest_TakeOwnership", EdgeProperties: map[string]interface{}{"traversable": false}},
	{EdgeType: "MSSQL_TakeOwnership", Description: "Database role can take ownership of another database role", SourcePattern: "TakeOwnershipTest_DbRole_Source@*\\EdgeTest_TakeOwnership", TargetPattern: "TakeOwnershipTest_DbRole_Target@*\\EdgeTest_TakeOwnership", EdgeProperties: map[string]interface{}{"traversable": false}},
	{EdgeType: "MSSQL_TakeOwnership", Description: "Application role can take ownership of database role", SourcePattern: "TakeOwnershipTest_AppRole_CanTakeRole@*\\EdgeTest_TakeOwnership", TargetPattern: "TakeOwnershipTest_DbRole_Target@*\\EdgeTest_TakeOwnership", EdgeProperties: map[string]interface{}{"traversable": false}},
